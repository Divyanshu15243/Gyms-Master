...
def send_sms_via_email(email, password, to_email, message):
    try:
...
# Example usage:
email = 'buntypatel59687@gmail.com'
password = 'kdwg wecn ayaq psci'
# Replace with correct carrier's SMS gateway email (e.g., Verizon, AT&T)
to_email = '1234567890@vtext.com'  # Example for Verizon
message = 'Hello from Email-to-SMS! This is a test message.'

send_sms_via_email(email, password, to_email, message)
...
def send_sms(to_phone_number, message):
    ...
    api_key='664abb84dc3f3a602e373cadfaf57893'
    to_phone_number='918849511366'
    message = "Hello! This is your gym reminder from D'Grit Gym."
